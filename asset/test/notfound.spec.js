...
test.describe('[Page] NotFound;', () => {
  test('The not found page should be displayed correctly.', async ({ page, }) => {
    await page.goto('http://localhost:8888/fadsfdsaj023902/fadsfsad82340u2/');
    await expect(page.getByText('No corresponding resource found at the current location.')).toBeInViewport();
